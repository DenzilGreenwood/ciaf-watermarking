# OpenAI + CIAF Watermarking - Quick Reference
...
evidence, watermarked = watermark_ai_output(artifact=response.text, ...)
...
for user_input in conversation:
    ...
    conversation_history.append(watermarked)
```
...
```python
from config import get_openai_client, get_full_config
...
| `No module named 'openai'` | `pip install openai ciaf-watermarks` |
...
- **CIAF Watermarks Docs:** [GitHub](https://github.com/your-org/ciaf-watermarks)
