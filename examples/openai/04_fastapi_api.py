"""
OpenAI + CIAF Watermarking - FastAPI Integration

A complete REST API example showing:
- POST /generate - Generate and watermark OpenAI responses
...
app = FastAPI(
    title="OpenAI + CIAF Watermarking API",
    description="Generate AI content with transparent watermarking",
    version="1.0.0",
)
...
async def root():
    """API information."""
    return {
        "name": "OpenAI + CIAF Watermarking API",
        "version": "1.0.0",
        "endpoints": {
...
async def generate_content(request: GenerateRequest):
    """
    Generate content with OpenAI and apply watermarking.
...
if __name__ == "__main__":
    ...
    print("=" * 70)
    print("OpenAI + CIAF Watermarking API")
    print("=" * 70)
