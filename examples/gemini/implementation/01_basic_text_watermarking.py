"""
Google Gemini + CIAF Watermarking - Basic Text Example

This example demonstrates the simplest integration:
1. Generate text with Google Gemini
...
def main():
    """Basic Gemini watermarking example."""
    ...
    print("=" * 70)
    print("Google Gemini + CIAF Watermarking - Basic Example")
    print("=" * 70)
    ...
    try:
        ...
        print(f"✅ Generated {len(gemini_text)} characters")
    ...
    try:
        evidence, watermarked_text = watermark_ai_output(
            ...
            model_version="1.5",  # Update based on your model version
    ...
    output_dir = f"outputs/gemini_basic/{evidence.artifact_id}"
    ...
    print("-" * 70)
    print(f"\nChanges: 'quantum' → 'QUANTUM' ({watermarked_text.count('quantum')} replacements)")
    ...
    print("=" * 70)
    print("\n📊 Summary:")
    print("   - Generated with: Google Gemini Flash")
    ...
    print("\n📂 Output Structure:")
    print(f"   {output_dir}/")
    print("   ├── 01_original.txt      (Raw Gemini output)")
    ...
    print("   - 03_streaming_response.py - Streaming with watermarks")
    print("   - 04_batch_processing.py - Batch processing")
