"""
Tests for ciaf_watermarks.audio.verification module.
...
class TestAudioVerificationExactMatch:
    ...
    def test_verify_exact_match_original(self, sample_audio_bytes, common_watermark_params):
...
class TestAudioVerificationNoMatch:
    ...
    def test_verify_completely_different_audio(self, sample_audio_bytes, common_watermark_params):
...
class TestAudioSpectralVerification:
    ...
    def test_verify_spectral_watermark(self, sample_audio_bytes, common_watermark_params):
        ...
        with patch("ciaf_watermarks.audio.core.apply_audio_metadata_watermark") as mock_meta:
            ...
            with patch("ciaf_watermarks.audio.core.apply_audio_spectral_watermark") as mock_apply:
                ...
                with patch("ciaf_watermarks.audio.core.get_audio_info") as mock_info:
                    ...
                    with patch(
                        "ciaf_watermarks.audio.spectral.extract_audio_spectral_watermark"
                    ) as mock_extract:
...
class TestAudioVerificationErrorHandling:
    ...
    def test_verify_wrong_artifact_type(self, sample_audio_bytes):
        ...
        from ciaf_watermarks.audio import verify_audio_artifact
